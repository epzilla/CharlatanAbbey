    ...
    return (
      <div className="med-scheduler">
        ...
        <div className="form-group">
          ...
          <input name="dosage" id="dosage" defaultValue={this.props.dosage || 0} type="number" /> mg.
        </div>
        <div className="form-group">
          <label htmlFor="recurrence">Every:</label>
          <input name="recurrence" id="recurrence" dosage={this.props.hours || 4} type="number" /> hrs.
        </div>
